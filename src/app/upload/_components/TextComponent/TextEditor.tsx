    ...
    <div className="mt-6 pb-10">
      <div className="flex items-center justify-around">
        ...
        >
          <svg
            ...
            focusable="false"
            tabIndex={-1}
            className="icon-12 pointer-events-none"
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
        ...
        >
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M8.893.25h2.732a.75.75 0 010 1.5h-2.23l-3.563 9.5h2.356a.75.75 0 110 1.5H2a.75.75 0 010-1.5h2.23l3.563-9.5H5.437a.75.75 0 010-1.5h3.456z"
            ></path>
          </svg>
        </button>
        <button
        ...
        >
          <svg
            ...
            focusable="false"
            tabIndex={-1}
            className="icon-12 w-4 pointer-events-none"
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
            ...
            >
              ...
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M0 1.25A.75.75 0 01.75.5h6.5a.75.75 0 010 1.5H.75A.75.75 0 010 1.25zm0 5a.75.75 0 01.75-.75h11.5a.75.75 0 010 1.5H.75A.75.75 0 010 6.25zm.75 4.25a.75.75 0 000 1.5h9.5a.75.75 0 000-1.5H.75z"
                ></path>
              </svg>
            </button>
            <button
            ...
            >
              ...
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M3 1.25A.75.75 0 013.75.5h5.5a.75.75 0 010 1.5h-5.5A.75.75 0 013 1.25zm-3 5a.75.75 0 01.75-.75h11.5a.75.75 0 010 1.5H.75A.75.75 0 010 6.25zm3.75 4.25a.75.75 0 000 1.5h5.5a.75.75 0 000-1.5h-5.5z"
                ></path>
              </svg>
            </button>
            <button
            ...
            >
              ...
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M13 1.25a.75.75 0 00-.75-.75h-6.5a.75.75 0 000 1.5h6.5a.75.75 0 00.75-.75zm0 5a.75.75 0 00-.75-.75H.75a.75.75 0 000 1.5h11.5a.75.75 0 00.75-.75zm-.75 4.25a.75.75 0 010 1.5h-9.5a.75.75 0 010-1.5h9.5z"
                ></path>
              </svg>
            </button>
          </div>
      ...
      <div>
        {editor && (
          <BubbleMenu
            editor={editor}
            className="bg-white p-2 shadow-2xl text-pink-600"
            // tippyOptions={{ duration: 200 }}
          >
            <button
              onClick={setLink}
              className={editor.isActive("link") ? "bg-pink-100" : ""}
            >
              <Link />
            </button>
          </BubbleMenu>
