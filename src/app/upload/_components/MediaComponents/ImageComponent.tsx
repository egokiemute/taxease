...
const ImageComponent = ({ entryId }: { entryId: string }) => {
  ...
  return (
    <div className="flex flex-col mt-20">
      <div
        id="myDiv"
        className={`relative hover:border-2 transition-all duration-100 ease-in mx-auto rounded-xl ${
      ...
      >
        <div
          ...
          className={`flex items-center justify-center min-h-[400px] aspect-video transition-all ease-in duration-200 ${
            !entryData?.content ? "bg-gray-100" : "bg-white "
          } rounded-lg m-4`}
        >
          {entryData?.content ? (
            <img
              src={entryData?.content}
              alt={entryData.extra1}
