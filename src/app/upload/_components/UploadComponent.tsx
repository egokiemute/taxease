...
import UploadNav from "../../../components/Header";
        ...
        <div className="content-container pt-10">
          <div>
            {step === STEPS.UPLOAD_MEDIA && (
              <div>
                <h2 className="text-center md:text-3xl font-bold text-2xl">
                ...
                <div
                  ...
                  className="border-[2px] border-[#CAF695] border-dashed rounded-lg mt-12 flex justify-around md:w-9/12 w-11/12 mx-auto cursor-pointer"
                >
                  <div className="flex flex-col items-center justify-center py-40 w-full">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <div className="text-center pt-3">
                        ...
                        <span className="border-b-2 border-b-[#CAF695] ml-1">
                          Browse
                        </span>
                      </div>
                    </div>
                ...
                <div className="pb-20">
                  {entries.map((entry, index) => {
                    if (
                      ...
                      return <MainTextComp key={entry.id} entryId={entry.id} />;
