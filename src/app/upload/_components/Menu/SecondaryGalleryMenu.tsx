...
const SecondaryGalleryMenu = (props: Props) => {
  ...
  return (
    <div>
      <button onClick={onCloseMenu} className="mb-5 mt-5 text-sm">
        Close
      </button>
      <button
        onClick={() => {
        ...
        <div>
          <div className="flex items-center space-x-3 mb-8">
            ...
            <h4 className="text-xl font-semibold">
              {toShowData?.type === "image" ? "Image" : "Video"}
            </h4>
          </div>
          <div>
            ...
            <div className="p-4 border-[1px] border-gray-200 rounded-lg">
              <div className="mb-6">
                {toShowData ? (
                  ...
                  <div>
                    <div
                      className="py-2 px-3 bg-white rounded-lg text-center border-[1px] mt-4 mb-2 fonseme
