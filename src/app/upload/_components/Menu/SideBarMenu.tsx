...
const SideBarMenu = (props: Props) => {
  ...
  const addEditor = (type: string) => {
    ...
    const newEditor = createEditor({
      ...
      editorProps: {
        attributes: {
          class:
            "prose w-full leading-3 p-5 focus:outline-[2px] focus:border-[2px] focus:border-pink-500 focus:outline-pink-500 rounded-xl transition-all ease-in duration-150 prose-a:font-semibold prose-a:text-pink-500 prose:leading-loose",
        },
      },
      content: Content,
    });
  ...
  return (
    <div
      className={`fixed top-0 w-[335px] right-0 z-50 bg-white shadow-xl h-full transition-all ease-in duration-200 ${
        isMenuOpen ? "translate-x-0" : "translate-x-[400px] opacity-0"
      }`}
    >
      <div className="p-2 px-10">
        <div className={`${selectedMenu === "main" ? "block" : "hidden"} py-5`}>
          <button onClick={onCloseMenu} className="mb-8 text-sm">
            Close
          </button>
            ...
            <div>
              ...
              <div>
                ...
                <div className="mt-5 text-sm">
                  <div
                    onClick={() => setSelectedmenu("secondary-text")}
                    className="flex items-center justify-between hover:bg-neutral-100 rounded-lg py-2 px-1"
                  >
        ...
        <div
          className={`${selectedMenu === "image" ? "block" : "hidden"} mt-5`}
        >
          <button onClick={onCloseMenu} className="mb-8 text-sm">
            Close
          </button>
              ...
              <div className="mt-5">
                ...
                <div className="mt-7">
                  ...
                  <div className="mt-3 grid grid-cols-2">
                    <button
                      onClick={MakeSmall}
                      className={`border-[2px] rounded-s-xl py-3 flex items-center justify-center ${
                        data?.extra2 === "small" ? "border-purple-500" : ""
                      }`}
                    >
                      <span>
                        <svg
                    ...
                    <button
                      onClick={Makelarge}
                      className={`border-[2px] rounded-e-xl py-3 flex items-center justify-center  ${
                        data?.extra2 === "large" ? "border-purple-500" : ""
                      }`}
                    >
                      <span>
                        <svg
        ...
        <div
          className={`${selectedMenu === "video" ? "block" : "hidden"} mt-5`}
        >
          <button onClick={onCloseMenu} className="mb-8 text-sm">
            Close
          </button>
        ...
        <div
          className={`${
            selectedMenu === "secondary-gallery" ? "block" : "hidden"
          }`}
        >
          <SecondaryGalleryMenu />
        </div>
        <div className={`${selectedMenu === "text" ? "block" : "hidden"} mt-5`}>
          <button onClick={onCloseMenu} className="mb-5 text-sm">
            Close
          </button>
        ...
        <div
          className={`${
            selectedMenu === "secondary-text" ? "block" : "hidden"
          } mt-5`}
        >
          <div
          ...
          <div>
            <div
              onClick={() => addEditor("heading")}
              className="bg-gray-50 p-2 mt-10"
            >
            ...
            <div
              onClick={() => addEditor("para-heading")}
              className="bg-gray-50 p-2 mt-2"
            >
