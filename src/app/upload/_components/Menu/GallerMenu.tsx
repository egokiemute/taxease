...
const GallerMenu = (props: Props) => {
  ...
  try {
    fileObjects = EntryData?.content?.trim()
          ...
          {fileObjects.map((file, index) => (
            <li
              ...
              onClick={() => {
                ...
                setSelectedmenu("secondary-gallery");
                if (api) {
                  api.reInit({ startIndex: index, watchDrag: false });
                }
              }}
              className={`px-2 hover:bg-gray-50 rounded-lg py-[6px] text-[15px] flex items-center justify-between ${
                selectedSlideIndex === index ? "bg-gray-200" : ""
              }`}
            >
          ...
          <div className="mt-3 grid grid-cols-2">
            <button
              ...
              className={`border-[2px] rounded-s-xl py-3 flex items-center justify-center ${
                EntryData?.extra2 === "small" ? "border-purple-500" : ""
              }`}
            >
              <span>
                <svg
            ...
            <button
              ...
              className={`border-[2px] rounded-e-xl py-3 flex items-center justify-center ${
                EntryData?.extra2 === "large" ? "border-purple-500" : ""
              }`}
            >
              <span>
                <svg
